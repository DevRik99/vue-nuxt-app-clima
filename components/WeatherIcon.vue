<template>
  <div v-if="icon == 'shower'" class="icon sun-shower">
    <div class="cloud"></div>
    <div class="sun">
      <div class="rays"></div>
    </div>
  ...
  <div v-else-if="icon == 'storm'" class="icon thunder-storm">
    <div class="cloud"></div>
    <div class="lightning">
      <div class="bolt"></div>
      <div class="bolt"></div>
  ...
  <div v-else-if="icon == 'cloudy'" class="icon cloudy">
    <div class="cloud"></div>
    <div class="cloud"></div>
  </div>
  <div v-else-if="icon == 'cloudy-dark'" class="icon cloudy">
    <div class="cloud-dark"></div>
    <div class="cloud-dark"></div>
  </div>

  <div v-else-if="icon == 'flurries'" class="icon flurries">
    <div class="cloud"></div>
    <div class="snow">
      <div class="flake"></div>
      <div class="flake"></div>
  ...
  <div v-else-if="icon == 'sunny'" class="icon sunny">
    <div class="sun">
      <div class="rays"></div>
    </div>
  </div>

  <div v-else-if="icon == 'rainy'" class="icon rainy">
    <div class="cloud"></div>
    <div class="rain"></div>
  </div>
</template>
...
/* Baed on https://codepen.io/joshbader/pen/EjXgqr */
.icon {
  position: relative;
...
.cloud-dark:after {
  ...
  height: 1em;
  background: currentColor;
  box-shadow: 0 0.4375em 0 -0.0625em dark;
}
.cloud-dark:nth-child(2) {
  z-index: 0;
  background: black;
